...
function renderResult(result, searchTerms, titleTag) {
  ...
  if (result.image) {
    ...
    wrapper.className = 'search-simple-result-image';
  ...
  if (result.title) {
    ...
    title.className = 'search-simple-result-title';
...
function clearSearchResults(block) {
  const searchResults = block.querySelector('.search-simple-results');
...
function searchResultsContainer(block) {
  ...
  results.className = 'search-simple-results';
...
function searchInput(block, config) {
  ...
  input.className = 'search-simple-input';
...
function searchBox(block, config) {
  ...
  box.classList.add('search-simple-box');
  box.append(
    searchIcon(),
